...
My MSc is focused on image enhancement with deep generative networks, under the supervision of [Asst. Prof. Ayşegül Dündar](http://www.cs.bilkent.edu.tr/~adundar/).

My current research interests are low-level computer vision for image enhancement, event-based vision, deep generative networks, and neural network optimization. 
